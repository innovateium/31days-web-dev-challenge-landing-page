...
const ShieldCheck = (props: ChallengeIconProps) => <HugeIcon icon={Shield01Icon} {...props} />;
const Tag = (props: ChallengeIconProps) => <HugeIcon icon={Tag01Icon} {...props} />;
const Layout = (props: ChallengeIconProps) => <HugeIcon icon={Layout01Icon} {...props} />;
const Mail = (props: ChallengeIconProps) => <HugeIcon icon={Mail01Icon} {...props} />;
const BarChart3 = (props: ChallengeIconProps) => <HugeIcon icon={BarChartIcon} {...props} />;
const History = (props: ChallengeIconProps) => <HugeIcon icon={WorkHistoryIcon} {...props} />;
const RefreshCcw = (props: ChallengeIconProps) => <HugeIcon icon={RefreshIcon} {...props} />;
const Briefcase = (props: ChallengeIconProps) => <HugeIcon icon={Briefcase01Icon} {...props} />;
const Coffee = (props: ChallengeIconProps) => <HugeIcon icon={Coffee01Icon} {...props} />;
const Rocket = (props: ChallengeIconProps) => <HugeIcon icon={RocketIcon} {...props} />;
const Zap = (props: ChallengeIconProps) => <HugeIcon icon={FlashIcon} {...props} />;
const MapPin = (props: ChallengeIconProps) => <HugeIcon icon={Location01Icon} {...props} />;
const Globe = (props: ChallengeIconProps) => <HugeIcon icon={GlobeIcon} {...props} />;
const Dumbbell = (props: ChallengeIconProps) => <HugeIcon icon={Dumbbell01Icon} {...props} />;
const Layers = (props: ChallengeIconProps) => <HugeIcon icon={Layers01Icon} {...props} />;
const ShoppingBag = (props: ChallengeIconProps) => <HugeIcon icon={ShoppingBag01Icon} {...props} />;
const Newspaper = (props: ChallengeIconProps) => <HugeIcon icon={News01Icon} {...props} />;
const Monitor = (props: ChallengeIconProps) => <HugeIcon icon={DashboardSquare01Icon} {...props} />;
const PlayCircle = (props: ChallengeIconProps) => <HugeIcon icon={PlayCircleIcon} {...props} />;
const Code2 = (props: ChallengeIconProps) => <HugeIcon icon={CodeIcon} {...props} />;
const Cloud = (props: ChallengeIconProps) => <HugeIcon icon={CloudIcon} {...props} />;
const DollarSign = (props: ChallengeIconProps) => <HugeIcon icon={Dollar01Icon} {...props} />;
const Binary = (props: ChallengeIconProps) => <HugeIcon icon={BinaryCodeIcon} {...props} />;
const HelpCircle = (props: ChallengeIconProps) => <HugeIcon icon={HelpCircleIcon} {...props} />;
const Box = (props: ChallengeIconProps) => <HugeIcon icon={PackageIcon} {...props} />;
const Bot = (props: ChallengeIconProps) => <HugeIcon icon={AiChat01Icon} {...props} />;
